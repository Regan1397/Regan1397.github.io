...
function boundingBoxCheck(){
	if (x<0) { x = 0; vx = -vx; }
	if (y<0) { y = 0; vy = -vy; }
	if (x>document.documentElement.clientWidth-20) { x = document.documentElement.clientHeight-20; vx = -vx; }
	if (y>document.documentElement.clientHeight-20) { y = document.documentElement.clientWidth-20; vy = -vy; }
	if (z > 40) {z = 40;}
	if (z < -40) {z = -40;}
